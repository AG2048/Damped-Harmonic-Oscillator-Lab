...
def main():
    ...
    ax1.errorbar(xdata, ydata, yerr=yerror, xerr=xerror, fmt=".", label="Quality Factors", color="blue")
    ...
    ax1.plot(xs, curve, label="Sinusoidal Best Fit Curve", color="black")
    ...
    ax1.set_xlabel("Pendulum length, L (m)")
    ax1.set_ylabel("Quality Factor, Q")
    ax1.set_title("A: Relationship between pendulum length and quality factor")
    ...
    ax2.set_xlabel("Pendulum length, L (m)")
    ax2.set_ylabel("Residual of quality factor, Qr")
    ax2.set_title("B: Residuals of the sinusoidal best fit curve")
    # Here is where you change how your graph is labelled.
    ...
    fig.savefig("Q vs L sin with grid.png")
