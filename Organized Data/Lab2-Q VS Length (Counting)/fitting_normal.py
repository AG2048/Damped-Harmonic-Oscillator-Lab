...
def main():
    ...
    ax1.plot(xs, curve, label="Normal Distribution Best Fit Curve", color="black")
    ...
    fig.savefig("Graphs/Q vs L normal distribution.png")
