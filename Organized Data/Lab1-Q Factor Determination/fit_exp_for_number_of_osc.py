...
filename = "ONLY WHOLE NUMBER OSCILLATIONS STARTING 0.3487.txt"  # from ~ +20 deg
...
def main():
    ...
    lincurve = linear(linxs, 0, 0.07249)
    ...
    ax1.plot(linxs, lincurve, label="A = 0.07249 rad", color="red", linewidth=2)
    # 0.0725 ± 0.0004
    ...
    ax1.set_xlabel("Number of oscillation after initial amplitude, N")
    ax1.set_ylabel("Amplitude of pendulum, A (rad)")
    ax1.set_title("Decaying amplitude for 0.447±0.005m long pendulum with initial amplitude 0.3487±0.0009rad")
    ...
    # ax2.set_title("Residuals of the exponential best fit curve")
    # # Here is where you change how your graph is labelled.
