...
def main():
    ...
    ax1.plot(xs, curve, label="Power Law Best Fit Curve", color="black")
    ...
    ax1.set_title("A: Relationship between pendulum length and period of oscillation")
    ...
    ax2.set_title("B: Residuals of the power law best fit curve")
    # Here is where you change how your graph is labelled.
    ...
    fig.savefig("Period vs Length SQRT Graph.png")
